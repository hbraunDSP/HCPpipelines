...
"$PipelineScripts"/FreeSurferHiresWhite_freesurfer6_cvn.sh "$SubjectID" "$SubjectDIR" "$T1wImage" "$T2wImage"
...
"$PipelineScripts"/FreeSurferHiresPial_freesurfer6_cvn.sh "$SubjectID" "$SubjectDIR" "$T1wImage" "$T2wImage"
