...
main()
{
	...
	gpuEnabledEddy=${HCPPIPEDIR}/global/binaries/eddy_cuda_debug.20160909
	...
	#eddy_command+="${mbarg} --ff=10 --nvoxhp=1000 --sep_offs_move --flm=quadratic --repol --ol_nstd=3 --ol_nvox=250 --ol_type=both --rms --niter=5 --verbose --fwhm=10,0,0,0,0 --data_is_shelled --cnr_maps --residuals "
	#eddy_command+="${mbarg} --ol_nstd=3 --ol_nvox=250 --ol_type=both --niter=5 --data_is_shelled --cnr_maps --residuals " #full set minus redundant
	#
	
	eddy_command+="--ol_nstd=3 --ol_nvox=250 --niter=5 --data_is_shelled --cnr_maps --residuals " #no --mb, no --ol_type
