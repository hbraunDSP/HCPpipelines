...
fsver=`mri_surf2surf -version`
if [[ "$fsver" = *dev* ]]; then
	tvalarg="$mridir"/orig.mgz
else
	tvalarg=""
fi

mri_surf2surf --s $SubjectID --sval-xyz white --reg $reg "$mridir"/T1w_hires.nii.gz --tval-xyz ${tvalarg} --tval white.hires --surfreg white --hemi lh
mri_surf2surf --s $SubjectID --sval-xyz white --reg $reg "$mridir"/T1w_hires.nii.gz --tval-xyz ${tvalarg} --tval white.hires --surfreg white --hemi rh
...
fsver=`mri_surf2surf -version`
if [[ "$fsver" = *dev* ]]; then
	tvalarg="$mridir"/T1w_hires.nii.gz
else
	tvalarg=""
fi

mri_surf2surf --s $SubjectID --sval-xyz white.deformed --reg $regII $mridir/orig.mgz --tval-xyz ${tvalarg} --tval white --surfreg white --hemi lh
mri_surf2surf --s $SubjectID --sval-xyz white.deformed --reg $regII $mridir/orig.mgz --tval-xyz ${tvalarg} --tval white --surfreg white --hemi rh
