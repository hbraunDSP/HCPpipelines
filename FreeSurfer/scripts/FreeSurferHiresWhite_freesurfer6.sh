...
#mri_convert "$mridir"/T1.mgz "$mridir"/T1w.nii.gz
  ...
  #bbregister seems to fail miserably on this T2 to T1 step... not at all sure why
  cp -f "$mridir"/transforms/eye.dat "$mridir"/transforms/T2wtoT1w.dat
